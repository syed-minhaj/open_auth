    ...
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    _c.sent();
                    return [4 /*yield*/, createUser({ username: cred.username, email: cred.email }).catch(function (err) {
                            console.log(err);
                            return { err: 'Database error check logs for more details' };
                        })];
                case 5:
                    userId = _c.sent();
                    return [4 /*yield*/, sendEmail(cred.email, "Your account has been created").catch(function (err) {
                            console.log(err);
                            return { err: 'Database error check logs for more details' };
                        })
                        // create jwt
