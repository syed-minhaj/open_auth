...
var userSchema = zod_1.z.object({
    ...
    userEmail: zod_1.z.string().email({ message: "invalid email form database , check database" })
});
function signInPass(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    _c.sent();
                    return [4 /*yield*/, (0, userdb_1.getUser)({ userEmail: cred.email }).catch(function (err) {
                            console.log(err);
                            return { err: 'Database error check logs for more details' };
                        })];
                case 5:
                    ...
                    jwt_tocken = (0, jsonwebtoken_1.sign)(verified_user, process.env.AUTH_SECRET);
