...
exports.opt_create = opt_create;
exports.opt_varify = opt_varify;
exports.opt_delete = opt_delete;
var pg_1 = require("pg");
function opt_create(userEmail, password) {
...
function opt_varify(userEmail, password) {
    return __awaiter(this, void 0, void 0, function () {
        var db, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
